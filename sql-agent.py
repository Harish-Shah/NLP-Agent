...
engine = create_engine("postgresql://anc2:admin@localhost:5432/finycsdb")
...
def get_current_user(state: AgentState, config: RunnableConfig): #config allows to pass data at runtime
